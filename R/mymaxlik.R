#' @title mymaxlik
#'
#' @param lfun function of the loglikelihood
#' @param x a vector of samples
#' @param param a vector of parameter values
#' @param ... other parameters for plot
#'
#' @return a list of important information and a graph
#' @importFrom graphics axis
#' @importFrom graphics points
#' @export
#'
#' @examples
#' \dontrun{mymaxlik(lfun=logbin, x = c(3,3,4,3,4,5,5,4),
#'  param = seq(0,1,length=1000),main="Binomial, n=20")}
