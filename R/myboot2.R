#' Title
#'
#' @param iter number of times code will run, more iterations leads to better results
#' @param x a vector of values
#' @param fun function that can look for desired statistic
#' @param alpha probability that the statistic does not lie within calculated range
#' @param ... parameters for the histogram output
#'
#' @return a histogram and a list of statistics that might be of interest
...
#'
#' @examples
#' myboot2(iter=1000, x = (1:10), col="#F34567")
