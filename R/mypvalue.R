...
#'
#' @param t0 T value
#' @param xmax something I'm sure
#' @param n number of items in the sample
#' @param alpha 1-alpha is the confidence
#'
#' @return a list with the bounds of the rejection region q and the pvalue pvalue
#' @importFrom stats dt
#' @importFrom stats pt
#' @importFrom stats qt
#' @export
